...
class ConfigBehavior {
    ...
    interface Api {
        @SuppressWarnings("UnusedReturnValue") boolean foo();
    }

    @Test void shouldFailToLoadMissingEndpointConfig() {
        Throwable thrown = catchThrowableOfType(() -> fixture.builderWithoutEndpointConfig().build(Api.class), NoSuchElementException.class);
